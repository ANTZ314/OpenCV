"""
Description:
UNTESTED changes changes made to a version of 'handwrite.py'

From:
https://stackoverflow.com/questions/42753988/digit-recognition-with-opencv-and-python

RUN:
python handwrite.py digits_cls2.plk photo_1.jpg
"""
import numpy as np
import cv2
...
def main():
	# Load the classifier
	clf = joblib.load("digits_cls2.pkl")		# 'digits_cls2.pkl' generated in python3

	# Default camera has index 0 
